...
"""The loader calls the post-load hook on the root only, so every OpenPangu
root has to own one: the sink attention's key is `k_layernorm(param_sink_key)`,
a derived tensor that is stale until the hook rebuilds it."""
