...
class EngineArgs:
    ...
    # Compatibility alias. Canonical runtime state lives in ArtifactConfig.
    ...
    def __post_init__(self):
        ...
        if self.enable_return_routed_experts:
            self.artifact_config.enable_routed_experts = True
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        model_group.add_argument(
            ...
            **artifact_kwargs["enable_routed_experts"],
        )
